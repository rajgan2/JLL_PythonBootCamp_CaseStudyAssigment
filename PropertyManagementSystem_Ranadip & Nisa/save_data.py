...
def save_rental():
    ...
    rental1 = Rental("R123", "T001", "P901", "2023-08-01", "2023-09-01")
    rental2 = Rental("R124", "T002", "P901", "2022-01-01", "2023-01-01")
    rental3 = Rental("R125", "T003", "P902", "2022-03-01", "2024-09-01")
...
if __name__ == "__main__":
    ...
    try:
        ...
        tenant1 = Tenant("T123", "John Doe", "1234554321", "john@example.com", "P456")
        tenant2 = Tenant("T456", "Jane Smith", "6758909876", "jane@example.com", "P789")
    
        # List of Tenant objects
        tenants_list = [tenant1, tenant2]
        ...
        property1 = Property("One Caesars Palace Dr.", "5","7","120000",end_date)
        property2 = Property("City Hall - 495 S. Main Street", "8","6","200000", end_date)
        property3 = Property("6720 Via Austi Parkway Suite 450", "7","6","350000", end_date)
        ...
        # Call the method to display tenant data        
        tenant_csv_file = "tenants_data.csv"
        display_tenant_data(tenant_csv_file)
